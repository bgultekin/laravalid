...
class FormBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testIntegration()
    {
        ...
        $html = (string)$this->form->text('uid');
        ...
        $html = (string)$this->form->email('email', null, ['placeholder' => 'Email']);
        ...
        $html = (string)$this->form->text('name');
        ...
        $html = (string)$this->form->password('pwd');
        ...
        $html = (string)$this->form->password('confirm_pwd');
        ...
        $html = (string)$this->form->text('first_name');
        ...
        $html = (string)$this->form->text('last_name');
        ...
        $html = (string)$this->form->text('photo');
        ...
        $html = (string)$this->form->select('gender', ['Female', 'Male']);// unsupported: boolean
        $this->assertEquals('<select name="gender"><option value="0">Female</option><option value="1">Male</option></select>', $html);

        $html = (string)$this->form->input('date', 'birthdate');
        ...
        $html = (string)$this->form->input('tel', 'phone');
        ...
        $html = (string)$this->form->number('duration');
        ...
        $html = (string)$this->form->textarea('description', null, ['rows' => 5]);
        ...
        $html = (string)$this->form->radio('roles[]', 'Admin');
        ...
        // overwrite 'accept'
        $html = (string)$this->form->file('avatar', ['accept' => '.csv,image/png']);
        ...
        $html = (string)$this->form->checkbox('settings[1][]', 'allow', true);
        ...
        $html = (string)$this->form->text('client_ip');
        ...
        $html = (string)$this->form->file('upload');
